  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background/10 backdrop-blur-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        neon: "bg-gradient-to-r from-neon-cyan to-neon-pink text-background font-semibold hover:from-neon-pink hover:to-neon-cyan glow-neon",
        glass: "glass text-foreground hover:bg-white/20",
        hero: "bg-gradient-to-r from-primary to-neon-cyan text-primary-foreground font-bold hover:from-neon-cyan hover:to-primary glow-primary scale-105 hover:scale-110 transition-all duration-300",
      },
      size: {
